...
/**
 * TODO: Refactor some of these tests to WebhdfsFacadeTest and WebHdfsWriterTest
 * @author Neeraj Jain
 */
public class WebHDFSWriterHandlerTest {
   ...
   * @throws InterruptedException
   */
  @Test(expectedExceptions = SinkHandlerException.class, enabled = false)
   ...
   * @throws Throwable
   */
  @Test(expectedExceptions = UnknownHostException.class, expectedExceptionsMessageRegExp = "unit-testProcessWithWebhdfsNull.*", enabled = false)
